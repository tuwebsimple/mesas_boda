...
document.getElementById('searchButton').addEventListener('click', () => {
    ...
    if (guest) {
        ...
        resultElement.innerHTML = '<span class="text-2xl md:text-2xl font-extrabold leading-tighter tracking-tighter text-red-500">Invitado no encontrado. <br> Tal vez quisiste decir:</span>';
        // Búsqueda difusa
